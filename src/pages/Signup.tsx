    ...
    <div className="min-h-screen bg-gradient-to-r from-[#f5f2ea] via-[#f5f2ea] to-[#e8e4d8] flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md p-8 rounded-2xl shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#ff725e] text-white py-3 px-4 rounded-lg hover:bg-[#ff8b7a] transition-colors font-medium"
          >
            Sign Up
          </button>
        </form>
        <p className="mt-8 text-center text-sm text-gray-600">
          ...
          <Link to="/login" className="text-[#ff725e] hover:text-[#ff8b7a] font-medium">
            Sign in
          </Link>
        </p>
      </div>
